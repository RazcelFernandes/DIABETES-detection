...
if menu == "🏠 Home":
    ...
    with st.form("form_diabetes"):
        ...
        with col1:
            pregnancies = st.number_input('🤰 Jumlah Kehamilan', min_value=0.0, value=0.0)
            glucose = st.number_input('🩸 Kadar Glukosa', min_value=0.0, value=0.0)
            blood_pressure = st.number_input('💉 Tekanan Darah', min_value=0.0, value=0.0)
            skin_thickness = st.number_input('📏 Ketebalan Kulit', min_value=0.0, value=0.0)
        ...
        with col2:
            ...
            age = st.number_input('📅 Usia', min_value=0.0, value=0.0)
